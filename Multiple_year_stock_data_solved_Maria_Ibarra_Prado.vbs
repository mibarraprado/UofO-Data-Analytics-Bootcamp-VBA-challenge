'Sub Multiple_year_stock_data: This VBA code runs the same macro to summarize the stock data on 
'everysheet of the workbook by calling Stock_data_summary()
'----------------------------------------------------------------------------------------------
...
'----------------------------------------------------------------------------------------------
'Sub Stock_data_summary():The VBA code below summarizes the yearly stock data
'----------------------------------------------------------------------------------------------
